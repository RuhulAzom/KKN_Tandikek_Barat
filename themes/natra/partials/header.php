...
<div class="row" style="">
	<?php if (!empty($teks_berjalan)): ?>
		<div class="" style="color:#fff; padding-top: .3rem; border-bottom: 1px solid #5858582e;position: relative; display:flex; align-items:center; padding:.5rem 0">
			<div class="" style="display: flex; align-items: center; gap: 1rem; bottom: 0; padding: 0 1rem; z-index: 2;">
				<span style="display: flex; align-items: center; gap: .2rem; color: #fee2e2;">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="" style="width: 1rem;">
				...
				<span style="display: flex; align-items: center; gap: .2rem; color: #fee2e2;">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 1rem;">
